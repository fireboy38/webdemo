...
<head>
	...
	<meta name="description" content="这是一个自动生成表白页面的程序，模版由jianghongfei.com.cn原创，麦葱做二次开发，刁小帅再次修改，仅限娱乐，不得用于商业用途">
	<title>情人节自动生成表白程序 —— By 刁小帅</title>
...
<body>
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				...
				<p>为了让更多的有情人终成眷属，特别制作此程序供你表白使用！</p>
			</div>
			<div id="/section-1/page-2" class="ft-page page-2" data-id="page-2">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali63.jpg'  alt="过去的阿狸一直是一个人生活，享受着孤独，也憧憬着爱情。" />
			</div>
			<div id="/section-1/page-3" class="ft-page page-3 left-img" data-id="page-3">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali35.jpg'  alt="一个人的长廊"/>
			</div>
			<div id="/section-1/page-4" class="ft-page page-4 full-img" data-id="page-4">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali6.jpg'  alt="一个人的山岗" />
			</div>
		</div>
		<div class="ft-section section-2" data-id="section-2">
			<div id="/section-2/page-1" class="ft-page page-5 full-img" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali19.jpg'  alt="一个人的山岗" />
			</div>
		...
		<div class="ft-section section-3" data-id="section-3">
			<div id="/section-3/page-1" class="ft-page page-11 full-img" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali24.jpg'  />
			</div>
			<div id="/section-3/page-2" class="ft-page page-12" data-id="page-2">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali25.jpg' />
			</div>
			<div id="/section-3/page-3" class="ft-page page-13" data-id="page-3">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali64.jpg' alt='可是阿狸的爱情又在哪里呢？' />
			...
			<div id="/section-3/page-4" class="ft-page page-14 left-img" data-id="page-4">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali46.jpg' />
			</div>
			<div id="/section-3/page-5" class="ft-page page-15 left-img" data-id="page-5">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali45.jpg' />
			</div>
			<div id="/section-3/page-6" class="ft-page page-16 left-img" data-id="page-6">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali66.jpg' />
			</div>
			<div id="/section-3/page-7" class="ft-page page-17 top-text" data-id="page-7">
				<h3 id="text-19" contenteditable="true">直到有一天阿狸与桃子相遇了</h3>
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali16.jpg' />
			</div>
		</div>
		<div class="ft-section section-4" data-id="section-4">
			<div id="/section-4/page-1" class="ft-page page-18 full-img" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali11.jpg'  />
			</div>
			<div id="/section-4/page-2" class="ft-page page-19" data-id="page-2">
				<h3 id="text-21" contenteditable="true">可是桃子会喜欢阿狸吗？</h3>
				<img src="http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali75.jpg" />
			</div>
			<div id="/section-4/page-3" class="ft-page page-20" data-id="page-3">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali59.png' />
				<h3 id="text-22" contenteditable="true">终于有一天，阿狸鼓起了勇气</h3>
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali9.jpg' />
			</div>
		...
		<div class="ft-section section-5" data-id="section-5">
			<div id="/section-5/page-1" class="ft-page page-25 left-img" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali37.jpg' />
			</div>
		...
		<div class="ft-section section-6" data-id="section-6">
			<div id="/section-6/page-1" class="ft-page page-32" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali62.jpg'  />
			</div>
			<div id="/section-6/page-2" class="ft-page page-33 top-text" data-id="page-2">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali3.jpg' />
			</div>
		...
		<div class="ft-section section-7" data-id="section-7">
			<div id="/section-7/page-1" class="ft-page page-39 left-img" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali2.jpg' />
			</div>
			<div id="/section-7/page-2" class="ft-page page-40" data-id="page-2">
				<h3 id="text-45" contenteditable="true">如果没有桃子在身后</h3>
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali14.jpg'  />
			</div>
			<div id="/section-7/page-3" class="ft-page page-41" data-id="page-3">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali30_1.jpg' class='img1'/>
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali30_2.jpg' class='img2'/>
			...
			<div id="/section-7/page-4" class="ft-page page-42" data-id="page-4">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali69.jpg'  />
			</div>
			<div id="/section-7/page-5" class="ft-page page-43" data-id="page-5">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali42.jpg' />
			...
			<div id="/section-7/page-6" class="ft-page page-44 left-img" data-id="page-6">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali0.jpg' />
			</div>
			<div id="/section-7/page-7" class="ft-page page-45 left-img" data-id="page-7">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali18.jpg' />
			</div>
		</div>
		<div class="ft-section section-8" data-id="section-8">
			<div id="/section-8/page-1" class="ft-page page-46" data-id="page-1">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali57.gif' />
				<h3>
			...
			<div id="/section-8/page-2" class="ft-page page-47 top-text" data-id="page-2">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali58.jpg' />
				<h3>
			...
			<div id="/section-8/page-3" class="ft-page page-48 left-img" data-id="page-3">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali65.jpg'  />
			</div>
			<div id="/section-8/page-4" class="ft-page page-49 full-img" data-id="page-4">
			<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali71.jpg' />
				<p class="text">
			...
			<div id="/section-8/page-5" class="ft-page page-50" data-id="page-5">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali50_1.jpg' class='img1' />
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali50_2.jpg' class='img2' />
			</div>
		...
		<div class="ft-section section-9" data-id="section-9">
			<div id="/section-9/page-1" class="ft-page page-52 full-img" data-id="page-1">
				...
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali20.jpg'  />
			</div>
			<div id="/section-9/page-2" class="ft-page page-53" data-id="page-2">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/iali68.jpg' alt='happy birthday' />
			...
			<div id="/section-9/page-4" class="ft-page page-55 right-img" data-id="page-4">
				<img src='http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/img/14915.jpg' />
				<p class="text">
	...
	<div class="write-ok">
		<div class="write-box">
			<h2>还差一步即可生成表白页面</h2>
			<p id="write-mp3">自定义背景音乐：<span id="text-music" contenteditable="true">http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/music/saveme.mp3</p>
		
			<p id="write-url">自定义表白链接：<u>http://<?php echo $_SERVER['HTTP_HOST']; ?>/love/2015/</u><span id="text-href" contenteditable="true"><?php echo time(); ?></span><i></i><u>.html</u></p>
			...
			<div class="write-share">
				<p>~\(≧▽≦)/~ 点击分享 发送给你的亲亲吧</p>
				<div class="bdsharebuttonbox"><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_tieba" data-cmd="tieba" title="分享到百度贴吧"></a><a href="#" class="bds_copy" data-cmd="copy" title="分享到复制网址"></a><a href="#" class="bds_more" data-cmd="more"></a> 谨代表刁小帅祝有情人终成眷属</div>
	...
	<audio id="bgmMusic" src="http://7vzpi5.com1.z0.glb.clouddn.com/music/saveme.mp3" autoplay="autoplay" loop preload="auto" type="audio/mp3"></audio>
    
	<script src="http://libs.baidu.com/jquery/1.8.3/jquery.min.js"></script>
	<script src="http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/js/all.min.js"></script>
	<script src="http://fireboyslove.oss-cn-shenzhen.aliyuncs.com/js/love.min.js"></script>
